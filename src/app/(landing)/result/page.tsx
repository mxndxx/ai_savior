    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#0D0D2B] via-[#1a1a3a] to-[#0D0D2B] text-white">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 lg:px-8 lg:py-24">
          ...
          <p className="mx-auto max-w-2xl text-xl leading-relaxed text-gray-300">
            AI 최대표가 분석한 개인 맞춤 N잡 아이템을 확인하세요
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-gray-100 bg-gray-50 p-8 shadow-xl">
            <div className="space-y-8">
              {/* Title */}
              <div className="text-center">
                <h2 className="mb-6 text-2xl font-bold text-[#0D0D2B] lg:text-3xl">
                  📌 분석 결과 요약
                </h2>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-lg leading-relaxed text-gray-700">
                  당신의 과거 경력
                  <span className="font-medium text-[#0D0D2B]">
                    (마케팅 업무)
                  </span>
                  , 현재 상태
                  <span className="font-medium text-[#0D0D2B]">
              ...
              <div className="space-y-6">
                {/* Item 1 */}
                <div className="group rounded-2xl border-2 border-gray-100 bg-white p-8 transition-all duration-300 hover:-translate-y-1 hover:border-[#DC2626] hover:shadow-xl">
                  <div className="mb-6 flex items-center">
                    ...
                    <div className="ml-4">
                      <h3 className="text-xl font-bold text-[#0D0D2B]">
                        온라인 마케팅 컨설팅
                      </h3>
                  ...
                  <div className="space-y-4">
                    <div className="rounded-lg bg-gray-50 p-4">
                      <h4 className="mb-2 flex items-center text-sm font-semibold text-gray-800">
                        <Zap className="mr-2 h-4 w-4 text-[#DC2626]" />
                        실행 이유
                      </h4>
                    ...
                    <div className="rounded-lg bg-gray-50 p-4">
                      <h4 className="mb-2 flex items-center text-sm font-semibold text-gray-800">
                        <TrendingUp className="mr-2 h-4 w-4 text-[#DC2626]" />
                        예상 수익 범위
                      </h4>
                ...
                <div className="group rounded-2xl border-2 border-gray-100 bg-white p-8 transition-all duration-300 hover:-translate-y-1 hover:border-[#DC2626] hover:shadow-xl">
                  ...
                  <div className="space-y-4">
                    <div className="rounded-lg bg-gray-50 p-4">
                      <h4 className="mb-2 flex items-center text-sm font-semibold text-gray-800">
                        <CheckCircle className="mr-2 h-4 w-4 text-[#DC2626]" />
                        추천 이유
                      </h4>
                      <p className="text-sm text-gray-600">
                    ...
                    <div className="rounded-lg bg-gray-50 p-4">
                      <h4 className="mb-2 flex items-center text-sm font-semibold text-gray-800">
                        <Target className="mr-2 h-4 w-4 text-[#DC2626]" />
                        추가 사례
                      </h4>
                      <p className="text-sm text-gray-600">
                        <span className="font-medium text-[#DC2626]">
          ...
          <div className="space-y-8">
            <h2 className="mx-auto max-w-2xl text-4xl leading-relaxed font-bold">
              ...
              <span className="text-red-500">
                AI 자동화 월5천 전략 10가지 비법서
              </span>
              <br />
              지금 무료로 받으세요.
            </h2>
            <p className="text-lg leading-relaxed text-gray-300">
              이 비법서는 지금까지 3,000명 이상의 N잡러들이 실행한 결과입니다.
              아래 버튼을 눌러 카카오톡방에서 바로 다운로드 받으세요.
            </p>
