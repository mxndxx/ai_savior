      ...
      <div className="prose max-w-none space-y-8">
        <section>
          ...
          <p className="leading-relaxed text-gray-700">
            본 이용약관은 N잡 AI(이하 &quot;사이트&quot;)의 서비스의 이용조건과
        ...
        <section>
          <h2 className="mb-4 text-xl font-semibold">제3조 약관 외 준칙</h2>
          <p className="leading-relaxed text-gray-700">
        ...
        <section>
          <h2 className="mb-4 text-xl font-semibold">제4조 이용계약 체결</h2>
          <ol className="list-inside list-decimal space-y-2 text-gray-700">
            <li>
        ...
        <section>
          <h2 className="mb-4 text-xl font-semibold">제5조 서비스 이용 신청</h2>
          <ol className="list-inside list-decimal space-y-2 text-gray-700">
            <li>
        ...
        <section>
          <h2 className="mb-4 text-xl font-semibold">제6조 개인정보처리방침</h2>
          <p className="mb-3 leading-relaxed text-gray-700">
        ...
        <section>
          <h2 className="mb-4 text-xl font-semibold">제7조 운영자의 의무</h2>
          <ol className="list-inside list-decimal space-y-2 text-gray-700">
            <li>
        ...
        <section>
          <h2 className="mb-4 text-xl font-semibold">제8조 회원의 의무</h2>
          <ol className="list-inside list-decimal space-y-2 text-gray-700">
            <li>
        ...
        <section>
          <h2 className="mb-4 text-xl font-semibold">제9조 서비스 이용 시간</h2>
          <ol className="list-inside list-decimal space-y-2 text-gray-700">
            <li>
        ...
        <section>
          <h2 className="mb-4 text-xl font-semibold">제12조 게시물의 관리</h2>
          <ol className="list-inside list-decimal space-y-2 text-gray-700">
            <li>
        ...
        <section>
          <h2 className="mb-4 text-xl font-semibold">제13조 게시물의 보관</h2>
          <p className="leading-relaxed text-gray-700">
        ...
        <section>
          <h2 className="mb-4 text-xl font-semibold">제15조 손해배상</h2>
          <ol className="list-inside list-decimal space-y-2 text-gray-700">
            <li>
        ...
        <section>
          <h2 className="mb-4 text-xl font-semibold">제16조 면책</h2>
          <ol className="list-inside list-decimal space-y-2 text-gray-700">
            <li>
